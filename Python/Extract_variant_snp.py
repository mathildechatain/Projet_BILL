...
# Fonction pour filtrer les SNP sur notre critère QUAL > 10, qui prend en entrée un fichier VCF et un fichier de sortie
        ...
        for line in infile:
            if line.startswith("#"):
                ...
                try:
                    ...
                    qual = float(cols[5])
                    if qual > 10:
                        # Si QUAL est supérieur à 10, écrire la ligne dans le fichier de sortie
                        outfile.write(line)
                except ValueError:
                    # Ignore si QUAL n'est pas un nombre
                    continue
...
for vcf_file in vcf_files:
    # Générer le nom du fichier de sortie en ajoutant "_SNP_filtered" au nom de base du fichier d'entrée
